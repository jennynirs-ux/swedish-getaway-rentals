-- V2 Phase 1: Property expenses tracking
...
CREATE TABLE IF NOT EXISTS public.expenses (
  ...
  description TEXT,
  amount INTEGER NOT NULL,             -- stored in öre (cents) for consistency with bookings
...
'Property expenses for profitability tracking and Skatteverket tax reporting. Amounts in öre.';
