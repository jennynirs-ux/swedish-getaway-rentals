...
const LakehouseBooking = () => {
  ...
  const lakehouseProperty = properties.find(p => p.title.toLowerCase().includes('lakehouse') || p.title.toLowerCase().includes('lake') || p.amenities?.some(a => a.toLowerCase().includes('lake'))) || properties[1] || properties[0];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2">
            <BookingForm propertyId={lakehouseProperty.id} propertyTitle={lakehouseProperty.title} pricePerNight={lakehouseProperty.price_per_night} currency={lakehouseProperty.currency} maxGuests={lakehouseProperty.max_guests} />
          </div>
