...
const PropertyCalendarOptimized = memo(({ 
  ...
  // Optimized availability query with caching and real-time updates
  ...
  // Memoized availability map for fast lookups
  ...
  // Optimized date availability check
              ...
              return (
                <div className="relative p-2 text-center">
                  <div className={`
                    ...
                    ${available ? 'hover:bg-primary hover:text-primary-foreground' : 'text-muted-foreground line-through'}
                  `}>
                    {date.getDate()}
                  </div>
