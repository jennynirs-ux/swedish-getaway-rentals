  ...
  return <section className="villa-section bg-card">
      <div className="villa-container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Every corner of Villa Häcken has been thoughtfully designed to provide the ultimate combination of luxury, comfort, and connection with nature.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {images.map((image, index) => <div key={index} className="group relative overflow-hidden rounded-xl aspect-[4/3] cursor-pointer">
        ...
        <div className="mt-12 relative overflow-hidden rounded-2xl aspect-[21/9]">
          <img src={villaInteriorImage} alt="Villa Hacken panoramic view" className="w-full h-full object-cover" />
