...
const GuestGuideDialog = ({ isOpen, onClose, property }: GuestGuideDialogProps) => {
  ...
  const defaultSections: GuideSection[] = [
    ...
    },
    {
      ...
      type: "list",
      items: [
        "By car: Take the E20 and exit at Lerum. Parking on site.",
        "By public transport: Train to Lerum station, then bus 533 to Häckenvägen.",
      ],
    },
    {
      id: "stop",
    ...
    },
    {
      ...
      icon: Key,
      type: "list",
      items: ["Check-in: 15:00", "Keys in lockbox by entrance", "Parking in front of house"],
    },
    {
      id: "wifi",
      title: "Wi-Fi",
    ...
    },
    {
      ...
      icon: Cog,
      type: "checkbox",
      items: ["Oven: press power + start", "Coffee maker: fill with water + brew", "Heating: adjust thermostat"],
    },
    {
      id: "waste",
      ...
      icon: Recycle,
      type: "list",
      items: ["Food → brown bin", "Paper → paper container", "Plastic → plastic container", "Glass → glass container"],
    },
    {
      id: "places",
    ...
    },
    {
      ...
      icon: BookOpen,
      type: "list",
      items: ["No shoes indoors", "Fika tradition", "Alcohol only at Systembolaget"],
    },
    {
      id: "rules",
      title: "House Rules",
    ...
    },
    {
      ...
      icon: LogOut,
      type: "checkbox",
      items: ["Empty trash", "Remove bed linens", "Close windows & lights", "Lock doors"],
    },
    {
      id: "ratings",
      title: "Star Rating",
  ...
  const renderSectionContent = (section: GuideSection) => {
    ...
    if (section.id === "ratings") {
      const ratingInfo = [
        ...
        { stars: 4, title: "Excellent", description: "Great experience with minor issues" },
