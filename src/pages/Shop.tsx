...
<section className="relative py-20 pt-28 overflow-hidden">
  {/* Skarp bakgrundsbild, inga overlays */}
  <div
    className="absolute inset-0 bg-cover bg-center bg-no-repeat"
    style={{ backgroundImage: `url(${forestHeroBg})` }}
  />

  {/* Innehåll: tvinga vit text på alla barn */}
  <div className="container mx-auto px-4 text-center relative z-10 [&_*]:!text-white">
    <h1 className="text-4xl md:text-6xl font-bold mb-6">
      Nordic Store
    </h1>

    <p className="text-2xl max-w-3xl mx-auto opacity-90">
    ...
    <div className="max-w-md mx-auto relative mt-6">
      ...
      <Input
        ...
        className="pl-10 bg-black/40 placeholder:!text-white !text-white"
      />
    </div>
  </div>
</section>
